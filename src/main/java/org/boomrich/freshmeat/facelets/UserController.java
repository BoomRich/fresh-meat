...
import org.boomrich.freshmeat.sessions.UserFacade;
...
public class UserController implements Serializable {
    ...
    @EJB
    private org.boomrich.freshmeat.sessions.UserFacade ejbFacade;
    ...
    public void AddUser(User user) {
        getFacade().addUser(user);
    }

    public User getUser(String email, String password) {
        System.out.println("!!!ENTER GET USER");
        return getFacade().getUser(email, password);
    }

    public boolean isUserExist(String email) {
        return getFacade().isSameUserExist(email);
    }
