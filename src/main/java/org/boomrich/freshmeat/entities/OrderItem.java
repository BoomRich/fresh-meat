...
public class OrderItem implements Serializable {
    ...
    public String getSumPriceString() {
        return String.valueOf(getProductId().getProductPrice().multiply(BigDecimal.valueOf(getAmount().intValue())));
    }
    
    public BigDecimal getSumPrice() {
        return getProductId().getProductPrice().multiply(BigDecimal.valueOf(getAmount().intValue()));
    }
